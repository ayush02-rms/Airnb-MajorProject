const sampleListings = [
  ...
  },
  {
    ...
    image:  "https://images.unsplash.com/photo-1502784444187-359ac186c5bb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHNraSUyMHZhY2F0aW9ufGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60",
    price: 3000,
    location: "Verbier",
    country: "Switzerland",
  },
...
// sample data to perform our operations on the database. This data can be used to populate the database with initial listings for testing and development purposes. Each listing includes a title, description, image, price, location, and country.
//module.exports = { data: sampleListings }; means this array becomes object now and we can access it in other files by importing it.